...
; CHECK-LT15: define spir_func %__mux_dma_event_t* @__refsi_dma_start_2d_write(i8 addrspace(1)* [[dstDmaPointer:%.*]], i8 addrspace(3)* [[srcDmaPointer:%.*]], i64 [[width:%.*]], i64 [[dstStride:%.*]], i64 [[srcStride:%.*]], i64 [[height:%.*]], %__mux_dma_event_t* [[event:%.*]]) #0 {
; CHECK-LT15:   [[dst_int:%.*]] = ptrtoint i8 addrspace(1)* [[dstDmaPointer]] to i64
; CHECK-LT15:   store volatile i64 [[dst_int]], i64* inttoptr (i64 536879136 to i64*), align 8
; CHECK-LT15:   [[src_int:%.*]] = ptrtoint i8 addrspace(3)* [[srcDmaPointer]] to i64
...
; CHECK-GE15: define spir_func ptr @__refsi_dma_start_2d_write(ptr addrspace(1) [[dstDmaPointer:%.*]], ptr addrspace(3) [[srcDmaPointer:%.*]], i64 [[width:%.*]], i64 [[dstStride:%.*]], i64 [[srcStride:%.*]], i64 [[height:%.*]], ptr [[event:%.*]]) #0 {
; CHECK-GE15:   [[dst_int:%.*]] = ptrtoint ptr addrspace(1) [[dstDmaPointer]] to i64
; CHECK-GE15:   store volatile i64 [[dst_int]], ptr inttoptr (i64 536879136 to ptr), align 8
; CHECK-GE15:   [[src_int:%.*]] = ptrtoint ptr addrspace(3) [[srcDmaPointer]] to i64
