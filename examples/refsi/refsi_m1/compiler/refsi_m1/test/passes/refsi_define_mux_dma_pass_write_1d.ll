...
; CHECK-LT15: define spir_func %__mux_dma_event_t* @__refsi_dma_start_seq_write(i8 addrspace(3)* [[argDstDmaPointer:%.*]], i8 addrspace(1)* [[argSrcDmaPointer:%.*]], i64 [[argWidth:%.*]], %__mux_dma_event_t* [[argEvent:%.*]]) #0 {
...
; CHECK-LT15:   br label %epilog
; CHECK-LT15:   [[load:%.*]] = load volatile i64, i64* inttoptr (i64 536879112 to i64*), align 8

; CHECK-GE15: define spir_func ptr @__refsi_dma_start_seq_write(ptr addrspace(3) [[argDstDmaPointer:%.*]], ptr addrspace(1) [[argSrcDmaPointer:%.*]], i64 [[argWidth:%.*]], ptr [[argEvent:%.*]]) #0 {
