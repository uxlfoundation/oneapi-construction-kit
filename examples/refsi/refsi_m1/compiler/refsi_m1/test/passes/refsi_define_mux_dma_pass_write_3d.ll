...
; CHECK-LT15: define spir_func %__mux_dma_event_t* @__refsi_dma_start_3d_write(i8 addrspace(3)* [[dstDmaPointer:%.*]], i8 addrspace(1)* [[srcDmaPointer:%.*]], i64 [[width:%.*]], i64 [[dstLineStride:%.*]], i64 [[srcLineStride:%.*]], i64 [[height:%.*]], i64 [[dstPlaneStride:%.*]], i64 [[srcPlaneStride:%.*]], i64 [[numPlanes:%.*]], i64 [[xxxx:%.*]], %__mux_dma_event_t* [[event:%.*]]) #0 {
...
; CHECK-GE15: define spir_func ptr @__refsi_dma_start_3d_write(ptr addrspace(3) [[dstDmaPointer:%.*]], ptr addrspace(1) [[srcDmaPointer:%.*]], i64 [[width:%.*]], i64 [[dstLineStride:%.*]], i64 [[srcLineStride:%.*]], i64 [[height:%.*]], i64 [[dstPlaneStride:%.*]], i64 [[srcPlaneStride:%.*]], i64 [[numPlanes:%.*]], i64 [[xxxx:%.*]], ptr [[event:%.*]]) #0 {
