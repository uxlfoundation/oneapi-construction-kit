...
from city_runner.test_info import TestRun, Pool

# This is needed to avoid blocking SIGINT on Python 2.x.
CV_TIMEOUT = 10.0
# How many seconds early remote processes timeout.
SSH_AGGRESSIVE_TIMEOUT = 2.0
# How many seconds it takes to reboot a board.
DEVICE_REBOOT_TIME = 120.0
...
class TestSchedule(object):
    ...
    and any running process. CityRunner accesses this state across multiple
    threads. This is why it is separated from TestRun.
    """
    def __init__(self, pool=Pool.NORMAL):
...
class TestRunBase(TestRun):
    ...
    def __init__(self, profile, test):
        ...
        self.schedule = TestSchedule(test.pool)
