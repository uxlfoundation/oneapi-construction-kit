// CopyRectright (C) Codeplay Software Limited. All Rights Reserved.
...
#define PARAMETERIZATION(name, src_buffer_size, dst_buffer_size, src_origin, \
  ...
  PARAMETERIZATION(copy_whole_buffer_2D, 256, 256, (ur_rect_offset_t{0, 0, 0}),
  ...
  PARAMETERIZATION(copy_3d_with_offsets, 512, 512, (ur_rect_offset_t{1, 2, 3}),
...
struct urEnqueueMemBufferCopyRectTestWithParam
    : public uur::QueueTestWithParam<uur::test_parameters_t> {};
...
struct urEnqueueMemBufferCopyRectTest : uur::QueueTest {
  void SetUp() override {
