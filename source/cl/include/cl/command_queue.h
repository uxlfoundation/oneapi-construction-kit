...
/// @brief Set a command queue property, deprecated in OpenCL 1.1 and unsupported
///
...
CL_API_ENTRY cl_int CL_API_CALL SetCommandQueueProperty(cl_command_queue command_queue,
    cl_command_queue_properties properties,
    cl_bool enable,
