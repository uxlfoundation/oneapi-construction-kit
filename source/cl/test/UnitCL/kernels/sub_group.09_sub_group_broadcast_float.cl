...
// REQUIRES: parameters
kernel void sub_group_broadcast_float(global float *in_a, global uint *in_b,
                                     global uint2 *out_a, global float *out_b) {
  ...
  out_b[glid] = sub_group_broadcast(in_a[glid], in_b[sgid]);
}
