...
// CL_STD: 3.0
__kernel void compare_exchange_strong_global_local_single_ulong(
    volatile __global atomic_ulong *atomic, __global ulong *expected_buffer,
    __global ulong *desired_buffer, int __global *bool_output_buffer,
    __local ulong *expected_local_buffer) {
