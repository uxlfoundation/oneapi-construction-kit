...
extern CL_API_ENTRY cl_command_buffer_khr CL_API_CALL clCreateCommandBufferKHR(
    cl_uint num_queues, const cl_command_queue *queues,
    const cl_command_buffer_properties_khr *properties, cl_int *errcode_ret);
...
extern CL_API_ENTRY void CL_API_CALL clLogMessagesToSystemLogAPPLE(
...
typedef cl_int(CL_API_CALL *clGetSemaphoreHandleForTypeKHR_fn)(
    ...
    void *handle_ptr, size_t *handle_size_ret) CL_API_SUFFIX__VERSION_1_2;
...
extern CL_API_ENTRY cl_int CL_API_CALL clGetImageRequirementsInfoEXT(
    ...
    void *param_value, size_t *param_value_size_ret) CL_API_SUFFIX__VERSION_3_0;
