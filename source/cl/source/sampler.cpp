...
_cl_sampler::_cl_sampler(cl_context context, cl_bool normalized_coords,
    ...
    : base<_cl_sampler>(cl::ref_count_type::EXTERNAL), context(context),
...
#define SAMPLER_INFO_CASE(TYPE, SIZE_RET, POINTER, VALUE)                      \
  ...
  default: {
    ...
    SAMPLER_INFO_CASE(CL_SAMPLER_CONTEXT, sizeof(_cl_context *), _cl_context **,
                      sampler->context);
    SAMPLER_INFO_CASE(CL_SAMPLER_NORMALIZED_COORDS, sizeof(cl_bool), cl_bool *,
