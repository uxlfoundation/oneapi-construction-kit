...
VKAPI_ATTR VkResult VKAPI_CALL vkCreateQueryPool(
  ...
  return vk::CreateQueryPool(vk::cast<vk::device>(device), pCreateInfo,
                             pAllocator, vk::cast<vk::query_pool*>(pQueryPool));
}
...
VKAPI_ATTR VkResult VKAPI_CALL vkCreatePipelineCache(
  ...
  return vk::CreatePipelineCache(vk::cast<vk::device>(device), pCreateInfo,
                                 pAllocator,
...
VKAPI_ATTR void VKAPI_CALL vkFreeCommandBuffers(
  ...
  vk::FreeCommandBuffers(
      vk::cast<vk::device>(device), vk::cast<vk::command_pool>(commandPool),
      commandBufferCount, vk::cast<const vk::command_buffer*>(pCommandBuffers));
}
...
VKAPI_ATTR void VKAPI_CALL vkCmdClearDepthStencilImage(
    VkCommandBuffer commandBuffer, VkImage, VkImageLayout,
