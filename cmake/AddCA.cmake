...
function(add_ca_configure_lit_site_cfg site_in site_out)
  ...
  # NOTE: Trick to avoid list arguments splitting in
  # `add_ca_configure_file()`. Wouldn't be needed if
  ...
  add_ca_configure_file(${site_in} ${site_out} DEFINED
    AUTOGENERATED_MESSAGE="This file was autogenerated by cmake. To make changes, edit ${CMAKE_CURRENT_SOURCE_DIR}/lit.site.cfg.in"
    llc_EXECUTABLE=$<TARGET_FILE:LLVM::llc>
    llvm-profdata_EXECUTABLE=$<TARGET_FILE:LLVM::llvm-profdata>
    llvm-cov_EXECUTABLE=$<TARGET_FILE:LLVM::llvm-cov>
    llvm-as_EXECUTABLE=$<TARGET_FILE:LLVM::llvm-as>
    llvm-dis_EXECUTABLE=$<TARGET_FILE:LLVM::llvm-dis>
    FileCheck_EXECUTABLE=$<TARGET_FILE:LLVM::FileCheck>
    not_EXECUTABLE=$<TARGET_FILE:LLVM::not>
