...
spv::Id OpGroupIAdd::Execution() const { return getValueAtOffset(3); }

spv::GroupOperation OpGroupIAdd::Operation() const {
  return static_cast<spv::GroupOperation>(getValueAtOffset(4));
}

spv::Id OpGroupIAdd::X() const { return getValueAtOffset(5); }

spv::Id OpGroupFAdd::Execution() const { return getValueAtOffset(3); }

spv::GroupOperation OpGroupFAdd::Operation() const {
  return static_cast<spv::GroupOperation>(getValueAtOffset(4));
}

spv::Id OpGroupFAdd::X() const { return getValueAtOffset(5); }

spv::Id OpGroupFMin::Execution() const { return getValueAtOffset(3); }

spv::GroupOperation OpGroupFMin::Operation() const {
  return static_cast<spv::GroupOperation>(getValueAtOffset(4));
}

spv::Id OpGroupFMin::X() const { return getValueAtOffset(5); }

spv::Id OpGroupUMin::Execution() const { return getValueAtOffset(3); }

spv::GroupOperation OpGroupUMin::Operation() const {
  return static_cast<spv::GroupOperation>(getValueAtOffset(4));
}

spv::Id OpGroupUMin::X() const { return getValueAtOffset(5); }

spv::Id OpGroupSMin::Execution() const { return getValueAtOffset(3); }

spv::GroupOperation OpGroupSMin::Operation() const {
  return static_cast<spv::GroupOperation>(getValueAtOffset(4));
}

spv::Id OpGroupSMin::X() const { return getValueAtOffset(5); }

spv::Id OpGroupFMax::Execution() const { return getValueAtOffset(3); }

spv::GroupOperation OpGroupFMax::Operation() const {
  return static_cast<spv::GroupOperation>(getValueAtOffset(4));
}

spv::Id OpGroupFMax::X() const { return getValueAtOffset(5); }

spv::Id OpGroupUMax::Execution() const { return getValueAtOffset(3); }

spv::GroupOperation OpGroupUMax::Operation() const {
  return static_cast<spv::GroupOperation>(getValueAtOffset(4));
}

spv::Id OpGroupUMax::X() const { return getValueAtOffset(5); }

spv::Id OpGroupSMax::Execution() const { return getValueAtOffset(3); }

spv::GroupOperation OpGroupSMax::Operation() const {
  return static_cast<spv::GroupOperation>(getValueAtOffset(4));
}

spv::Id OpGroupSMax::X() const { return getValueAtOffset(5); }
