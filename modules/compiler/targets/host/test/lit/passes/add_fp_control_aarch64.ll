...
; FTZ: define internal spir_func void @add(ptr addrspace(1) readonly %in1, ptr addrspace(1) readonly %in2, ptr addrspace(1) %out, i8 signext %i) [[ATTRS:#[0-9]+]] !test [[MD:\![0-9]+]] {
...
; FTZ: call spir_func void @add(ptr addrspace(1) readonly %in1, ptr addrspace(1) readonly %in2, ptr addrspace(1) %out, i8 signext %i)
