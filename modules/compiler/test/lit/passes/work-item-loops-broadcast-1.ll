...
attributes #0 = { convergent norecurse nounwind "mux-kernel"="entry-point" "mux-local-mem-usage"="0" "mux-orig-fn"="_ZTS22broadcast_group_kernelILi1EiE" "vecz-mode"="never" }
