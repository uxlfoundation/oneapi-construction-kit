...
; RUN: %muxc --passes replace-barriers -S %s | %filecheck %s
...
define spir_kernel void @barriersKrnl() {
  ...
  ; CHECK: call void @__mux_work_group_barrier(i32 0, i32 2, i32 272) [[NEW_ATTRS:#[0-9]+]]
  ; CLK_LOCAL_MEM_FENCE
  call spir_func void @_Z18work_group_barrierj(i32 1) #0

  ; ID, WorkGroup, SequentiallyConsistent|CrossWorkGroupMemory
  ; CHECK: call void @__mux_work_group_barrier(i32 0, i32 2, i32 528) [[NEW_ATTRS]]
  ...
  ; CHECK: call void @__mux_work_group_barrier(i32 0, i32 2, i32 784) [[NEW_ATTRS]]
  ...
  ; CHECK: call void @__mux_work_group_barrier(i32 0, i32 1, i32 784) [[NEW_ATTRS]]
  ...
  ; CHECK: call void @__mux_sub_group_barrier(i32 0, i32 3, i32 528) [[NEW_ATTRS]]
  ; CLK_GLOBAL_MEM_FENCE
  ...
  ; CHECK: call void @__mux_sub_group_barrier(i32 0, i32 4, i32 784) [[NEW_ATTRS]]
  ...
  ; CHECK: call void @__mux_mem_barrier(i32 3, i32 520) [[NEW_ATTRS]]
...
; CHECK-DAG: declare void @__mux_work_group_barrier(i32, i32, i32) [[NEW_ATTRS]]
; CHECK-DAG: declare void @__mux_sub_group_barrier(i32, i32, i32) [[NEW_ATTRS]]
