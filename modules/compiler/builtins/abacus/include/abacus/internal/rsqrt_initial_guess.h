...
template <> inline abacus_ushort rsqrt_initial_guess_helper<abacus_half>() {
...
template <> inline abacus_uint rsqrt_initial_guess_helper<abacus_float>() {
  return 0x5f3759dfu;
}

#ifdef __CA_BUILTINS_DOUBLE_SUPPORT
template <> inline abacus_ulong rsqrt_initial_guess_helper<abacus_double>() {
  return 0x5fe6eb50c7b537a9u;
}
#endif // __CA_BUILTINS_DOUBLE_SUPPORT

template <typename T> inline T rsqrt_initial_guess(T x) {
