...
; CHECK: define void @add.refsi-wrapper(i64 %instance, i64 %slice, ptr readonly %args, ptr readonly %wg)
...
; CHECK: call void @add(ptr readonly [[ARGS:%.*]], ptr readonly [[WG_INFO]])
...
define void @add(%MuxPackedArgs.add* readonly %args, %MuxWorkGroupInfo* readonly %wg) #0 {
  ret void
}
