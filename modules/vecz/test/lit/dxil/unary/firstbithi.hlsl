...
// Build command: dxc -T cs_6_0 -E CSMain firstbithi.hlsl -Fo firstbithi.bc

// RUN: %veczc -o %t.bc %S/firstbithi.bc -k CSMain -w 2
// RUN: %llvm-dis -o %t.ll %t.bc
// RUN: %filecheck < %t.ll %s

RWStructuredBuffer<uint2x1> a;
...
// firstbithigh always maps to firstbitshi even if the input type is unsigned!
