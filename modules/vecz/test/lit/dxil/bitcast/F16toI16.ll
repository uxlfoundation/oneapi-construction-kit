...
; ModuleID = 'F16toI16.bc'
source_filename = "F16toI16.dxil"
...
define void @main(%types.in addrspace(0)* %ptr) {
  ...
  %bc = call %types.out @dx.op.bitcastF16toI16(i32 125, %types.in %x)
  ret void
}
...
declare %types.out @dx.op.bitcastF16toI16(i32, %types.in) #0
