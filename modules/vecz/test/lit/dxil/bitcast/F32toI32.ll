...
; ModuleID = 'F32toI32.bc'
source_filename = "F32toI32.dxil"
...
define void @main(%types.in addrspace(0)* %ptr) {
  ...
  %bc = call %types.out @dx.op.bitcastF32toI32(i32 127, %types.in %x)
  ret void
}
...
declare %types.out @dx.op.bitcastF32toI32(i32, %types.in) #0
