...
; CHECK-NOT: ptrtoint
; CHECK-NOT: inttoptr
; CHECK-GE15: %[[RPHI:.+]] = phi ptr addrspace(1) [ %in, %entry ], [ %[[RGEP:.+]], %for.body ]
; CHECK-GE15: %[[RGEP]] = getelementptr i8, ptr addrspace(1) %[[RPHI]], i{{32|64}} 4
; CHECK-GE15: load i32, ptr addrspace(1) %[[RGEP]], align 4
; CHECK-LT15: %[[RPHI:.+]] = phi i8 addrspace(1)* [ %in, %entry ], [ %[[RGEP:.+]], %for.body ]
; CHECK-LT15: %[[RGEP]] = getelementptr i8, i8 addrspace(1)* %[[RPHI]], i{{32|64}} 4
; CHECK-LT15: %[[RCAST:.+]] = bitcast i8 addrspace(1)* %[[RGEP]] to i32 addrspace(1)*
; CHECK-LT15: load i32, i32 addrspace(1)* %[[RCAST]], align 4
