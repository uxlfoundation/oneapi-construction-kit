...
; CHECK-LT15:  %[[WIDEN:.+]] = call <vscale x 16 x i32> @llvm.experimental.vector.insert.nxv16i32.nxv8i32(<vscale x 16 x i32> poison, <vscale x 8 x i32> %[[DATA]], i64 0)
; CHECK-GE15:  %[[WIDEN:.+]] = call <vscale x 16 x i32> @llvm.vector.insert.nxv16i32.nxv8i32(<vscale x 16 x i32> poison, <vscale x 8 x i32> %[[DATA]], i64 0)
; CHECK-LT15:  %[[GATHER:.+]] = call <vscale x 16 x i32> @llvm.riscv.vrgather.vv.nxv16i32.i64(<vscale x 16 x i32> %[[WIDEN]], <vscale x 16 x i32> %{{.+}}, i64 %{{.+}})
; CHECK-GE15:  %[[GATHER:.+]] = call <vscale x 16 x i32> @llvm.riscv.vrgather.vv.nxv16i32.i64(<vscale x 16 x i32> undef, <vscale x 16 x i32> %[[WIDEN]], <vscale x 16 x i32> %{{.+}}, i64 %{{.+}})
