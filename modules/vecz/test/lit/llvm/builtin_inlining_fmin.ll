...
; CHECK-GE15: define spir_kernel void @__vecz_v4_fminff(float %a, float %b, ptr %c)
; CHECK-LT15: define spir_kernel void @__vecz_v4_fminff(float %a, float %b, float* %c)
; CHECK: entry:
...
; CHECK-GE15: define spir_kernel void @__vecz_v4_fminvf(<2 x float> %a, float %b, ptr %c)
; CHECK-LT15: define spir_kernel void @__vecz_v4_fminvf(<2 x float> %a, float %b, <2 x float>* %c)
; CHECK: entry:
