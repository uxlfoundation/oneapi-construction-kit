...
; CHECK-GE15:  call void @llvm.masked.scatter.v4f64.v4p1(<4 x double> %0, <4 x ptr addrspace(1)> %2, i32{{( immarg)?}} 8, <4 x i1> <i1 true, i1 true, i1 true, i1 true>)
; CHECK-LT15:  call void @llvm.masked.scatter.v4f64.v4p1f64(<4 x double> %0, <4 x double addrspace(1)*> %2, i32{{( immarg)?}} 8, <4 x i1> <i1 true, i1 true, i1 true, i1 true>)
; CHECK: ret void
