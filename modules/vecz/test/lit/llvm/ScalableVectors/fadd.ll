...
; RUN: %veczc -k fadd -vecz-scalable -vecz-simd-width=4 -S < %s | %filecheck %t
...
; CHECK-GE15: load <vscale x 4 x float>, ptr
; CHECK-LT15: load <vscale x 4 x float>, <vscale x 4 x float>*
; CHECK-GE15: load <vscale x 4 x float>, ptr
; CHECK-LT15: load <vscale x 4 x float>, <vscale x 4 x float>*
