...
; CHECK-GE15: [[lhs:%[0-9a-z]+]] = load <vscale x 16 x i32>, ptr
; CHECK-LT15: [[lhs:%[0-9a-z]+]] = load <vscale x 16 x i32>, <vscale x 16 x i32>*
; CHECK-GE15: [[rhs:%[0-9a-z]+]] = load <vscale x 16 x i32>, ptr
; CHECK-LT15: [[rhs:%[0-9a-z]+]] = load <vscale x 16 x i32>, <vscale x 16 x i32>*
