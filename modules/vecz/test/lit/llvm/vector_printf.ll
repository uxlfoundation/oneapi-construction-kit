...
; RUN: %veczc -k test -vecz-simd-width=4 -vecz-choices=FullScalarization -S < %s | %filecheck %t
...
; CHECK-GE15: call spir_func i32 (ptr addrspace(2), ...) @printf(ptr addrspace(2) @[[STR]], i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}})
; CHECK-LT15: call spir_func i32 (i8 addrspace(2)*, ...) @printf(i8 addrspace(2)* getelementptr inbounds ([29 x i8], [29 x i8] addrspace(2)* @[[STR]], i64 0, i64 0), i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}})
; CHECK-GE15: call spir_func i32 (ptr addrspace(2), ...) @printf(ptr addrspace(2) @[[STR]], i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}})
; CHECK-LT15: call spir_func i32 (i8 addrspace(2)*, ...) @printf(i8 addrspace(2)* getelementptr inbounds ([29 x i8], [29 x i8] addrspace(2)* @[[STR]], i64 0, i64 0), i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}})
; CHECK-GE15: call spir_func i32 (ptr addrspace(2), ...) @printf(ptr addrspace(2) @[[STR]], i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}})
; CHECK-LT15: call spir_func i32 (i8 addrspace(2)*, ...) @printf(i8 addrspace(2)* getelementptr inbounds ([29 x i8], [29 x i8] addrspace(2)* @[[STR]], i64 0, i64 0), i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}}, i8 %{{.+}})
