...
; RUN: %veczc -k test_float_vectors -vecz-simd-width=4 -S < %s | %filecheck %t
...
; CHECK-GE15: call spir_func i32 (ptr addrspace(2), ...) @printf(ptr addrspace(2) @[[STR]], double %[[V5]], double %[[V10]])
; CHECK-LT15: call spir_func i32 (i8 addrspace(2)*, ...) @printf(i8 addrspace(2)* getelementptr inbounds ([13 x i8], [13 x i8] addrspace(2)* @[[STR]], i64 0, i64 0), double %[[V5]], double %[[V10]])
; CHECK-GE15: call spir_func i32 (ptr addrspace(2), ...) @printf(ptr addrspace(2) @[[STR]], double %[[V6]], double %[[V11]])
; CHECK-LT15: call spir_func i32 (i8 addrspace(2)*, ...) @printf(i8 addrspace(2)* getelementptr inbounds ([13 x i8], [13 x i8] addrspace(2)* @[[STR]], i64 0, i64 0), double %[[V6]], double %[[V11]])
; CHECK-GE15: call spir_func i32 (ptr addrspace(2), ...) @printf(ptr addrspace(2) @[[STR]], double %[[V7]], double %[[V12]])
; CHECK-LT15: call spir_func i32 (i8 addrspace(2)*, ...) @printf(i8 addrspace(2)* getelementptr inbounds ([13 x i8], [13 x i8] addrspace(2)* @[[STR]], i64 0, i64 0), double %[[V7]], double %[[V12]])
; CHECK-GE15: call spir_func i32 (ptr addrspace(2), ...) @printf(ptr addrspace(2) @[[STR]], double %[[V8]], double %[[V13]])
; CHECK-LT15: call spir_func i32 (i8 addrspace(2)*, ...) @printf(i8 addrspace(2)* getelementptr inbounds ([13 x i8], [13 x i8] addrspace(2)* @[[STR]], i64 0, i64 0), double %[[V8]], double %[[V13]])
; CHECK: ret void
