...
; RUN: %veczc -k convert3 -vecz-simd-width=2 -vecz-choices=FullScalarization -S < %s | %filecheck %t
...
; CHECK-GE15: call void @__vecz_b_interleaved_store4_3_Dv2_fu3ptrU3AS1(<2 x float>
; CHECK-LT15: call void @__vecz_b_interleaved_store4_3_Dv2_fPU3AS1f(<2 x float>
