...
; RUN: %veczc -k add:4,8,16 -S < %s | %filecheck %t

; CHECK-GE15: define spir_kernel void @add(ptr addrspace(1) %in1, ptr addrspace(1) %in2, ptr addrspace(1) %out) {{.*}} !codeplay_ca_vecz.base ![[BASE_1:[0-9]+]] !codeplay_ca_vecz.base ![[BASE_2:[0-9]+]] !codeplay_ca_vecz.base ![[BASE_3:[0-9]+]] {
; CHECK-LT15: define spir_kernel void @add(i32 addrspace(1)* %in1, i32 addrspace(1)* %in2, i32 addrspace(1)* %out) {{.*}} !codeplay_ca_vecz.base ![[BASE_1:[0-9]+]] !codeplay_ca_vecz.base ![[BASE_2:[0-9]+]] !codeplay_ca_vecz.base ![[BASE_3:[0-9]+]] {
; CHECK-GE15: define spir_kernel void @__vecz_v[[DERIVED_1_VF:[0-9]+]]_add(ptr addrspace(1) %in1, ptr addrspace(1) %in2, ptr addrspace(1) %out) {{.*}} !codeplay_ca_vecz.derived ![[DERIVED_1:[0-9]+]] {
; CHECK-LT15: define spir_kernel void @__vecz_v[[DERIVED_1_VF:[0-9]+]]_add(i32 addrspace(1)* %in1, i32 addrspace(1)* %in2, i32 addrspace(1)* %out) {{.*}} !codeplay_ca_vecz.derived ![[DERIVED_1:[0-9]+]] {
; CHECK-GE15: define spir_kernel void @__vecz_v[[DERIVED_2_VF:[0-9]+]]_add(ptr addrspace(1) %in1, ptr addrspace(1) %in2, ptr addrspace(1) %out) {{.*}} !codeplay_ca_vecz.derived ![[DERIVED_2:[0-9]+]] {
; CHECK-LT15: define spir_kernel void @__vecz_v[[DERIVED_2_VF:[0-9]+]]_add(i32 addrspace(1)* %in1, i32 addrspace(1)* %in2, i32 addrspace(1)* %out) {{.*}} !codeplay_ca_vecz.derived ![[DERIVED_2:[0-9]+]] {
; CHECK-GE15: define spir_kernel void @__vecz_v[[DERIVED_3_VF:[0-9]+]]_add(ptr addrspace(1) %in1, ptr addrspace(1) %in2, ptr addrspace(1) %out) {{.*}} !codeplay_ca_vecz.derived ![[DERIVED_3:[0-9]+]] {
; CHECK-LT15: define spir_kernel void @__vecz_v[[DERIVED_3_VF:[0-9]+]]_add(i32 addrspace(1)* %in1, i32 addrspace(1)* %in2, i32 addrspace(1)* %out) {{.*}} !codeplay_ca_vecz.derived ![[DERIVED_3:[0-9]+]] {
