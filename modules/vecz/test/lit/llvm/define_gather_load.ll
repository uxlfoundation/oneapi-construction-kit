...
; CHECK-GE15: %[[V1:[0-9]+]] = call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> %0, i32{{( immarg)?}} 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>,
; CHECK-LT15: %[[V1:[0-9]+]] = call <4 x i64> @llvm.masked.gather.v4i64.v4p0i64(<4 x i64*> %0, i32{{( immarg)?}} 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>,
