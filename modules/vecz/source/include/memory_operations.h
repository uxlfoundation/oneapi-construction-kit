...
class MemOpDesc {
 ...
 public:
  ...
  /// llvm::None otherwise.
  static llvm::Optional<MemOpDesc> analyzeMemOpFunction(llvm::Function &F);
  ...
  /// llvm::None otherwise.
  static llvm::Optional<MemOpDesc> analyzeMaskedMemOp(llvm::Function &F);
  ...
  static llvm::Optional<MemOpDesc> analyzeInterleavedMemOp(llvm::Function &F);
  ...
  /// operation. llvm::None otherwise.
  static llvm::Optional<MemOpDesc> analyzeMaskedInterleavedMemOp(
      llvm::Function &F);
  ...
  /// llvm::None otherwise.
  static llvm::Optional<MemOpDesc> analyzeScatterGatherMemOp(llvm::Function &F);
  ...
  /// operation. llvm::None otherwise.
  static llvm::Optional<MemOpDesc> analyzeMaskedScatterGatherMemOp(
      llvm::Function &F);
...
struct MemOp {
  ...
  static llvm::Optional<MemOp> get(llvm::Instruction *I);
  /// @brief Create a memory operation from an instruction and an existing
  /// memory operation descriptor.
  ///
  /// @param[in] CI Memory builtin call instruction.
  /// @param[in] AccessKind the kind of access to consider
  static llvm::Optional<MemOp> get(llvm::CallInst *CI,
                                   MemOpAccessKind AccessKind);
