...
#ifndef STUB_STUB_H_INCLUDED
#define STUB_STUB_H_INCLUDED
...
/// @brief Stub major version number.
#define STUB_MAJOR_VERSION 0
/// @brief Stub minor version number.
#define STUB_MINOR_VERSION 71
/// @brief Stub patch version number.
#define STUB_PATCH_VERSION 0
/// @brief Stub combined version number.
#define STUB_VERSION                      \
  (((uint32_t)STUB_MAJOR_VERSION << 22) | \
   ((uint32_t)STUB_MINOR_VERSION << 12) | ((uint32_t)STUB_PATCH_VERSION))
...
///
/// stubFlushMappedMemoryToDevice is intended to be used with mux_memory_ts
...
///
/// stubFlushMappedMemoryFromDevice is intended to be used with mux_memory_ts
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t stubQueryLocalSizeForSubGroupCount(mux_kernel_t kernel,
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t stubQuerySubGroupSizeForLocalSize(mux_kernel_t kernel,
                                               size_t local_size_x,
                                               size_t local_size_y,
                                               size_t local_size_z,
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t stubQueryWFVInfoForLocalSize(
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t stubTryWait(mux_queue_t queue, uint64_t timeout,
                         mux_fence_t fence);
