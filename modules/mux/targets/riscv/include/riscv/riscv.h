...
#ifndef RISCV_RISCV_H_INCLUDED
#define RISCV_RISCV_H_INCLUDED
...
///
/// riscvFlushMappedMemoryToDevice is intended to be used with mux_memory_ts
...
///
/// riscvFlushMappedMemoryFromDevice is intended to be used with mux_memory_ts
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t riscvGetQueue(mux_device_t device, mux_queue_type_e queue_type,
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t riscvCreateCommandBuffer(mux_device_t device,
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t riscvCommandReadBuffer(
    mux_command_buffer_t command_buffer, mux_buffer_t buffer, uint64_t offset,
    void *host_pointer, uint64_t size, uint32_t num_sync_points_in_wait_list,
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t riscvCommandReadBufferRegions(
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t riscvCommandWriteBufferRegions(
    mux_command_buffer_t command_buffer, mux_buffer_t buffer,
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t riscvCommandCopyBuffer(
    mux_command_buffer_t command_buffer, mux_buffer_t src_buffer,
    uint64_t src_offset, mux_buffer_t dst_buffer, uint64_t dst_offset,
    uint64_t size, uint32_t num_sync_points_in_wait_list,
    const mux_sync_point_t *sync_point_wait_list, mux_sync_point_t *sync_point);
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t riscvCommandCopyBufferRegions(
    mux_command_buffer_t command_buffer, mux_buffer_t src_buffer,
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t riscvCommandFillBuffer(
    mux_command_buffer_t command_buffer, mux_buffer_t buffer, uint64_t offset,
    uint64_t size, const void *pattern_pointer, uint64_t pattern_size,
    uint32_t num_sync_points_in_wait_list,
    const mux_sync_point_t *sync_point_wait_list, mux_sync_point_t *sync_point);
...
mux_result_t riscvCommandBeginQuery(
...
///
/// @return mux_success, or a mux_error_* error code in an error occurred.
mux_result_t riscvCommandResetQueryPool(
    mux_command_buffer_t command_buffer, mux_query_pool_t query_pool,
    uint32_t query_index, uint32_t query_count,
    uint32_t num_sync_points_in_wait_list,
    const mux_sync_point_t *sync_point_wait_list, mux_sync_point_t *sync_point);
...
///
/// @return mux_success, or a mux_error_* if an error occurred.
mux_result_t riscvWaitAll(mux_queue_t queue);
